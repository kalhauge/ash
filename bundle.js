...
Elm.Grammar = Elm.Grammar || {};
Elm.Grammar.make = function (_elm) {
   "use strict";
   _elm.Grammar = _elm.Grammar || {};
   if (_elm.Grammar.values) return _elm.Grammar.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var get = F3(function (clauseId,altId,grammar) {
   ...
   var Lex = function (a) {    return {ctor: "Lex",_0: a};};
   var oneOf = function (str) {
      return rule(A2($List.map,
      function (_p0) {
         return function (x) {
            return _U.list([Lex(x)]);
         }($String.fromChar(_p0));
      },
      $String.toList(str)));
   };
   return _elm.Grammar.values = {_op: _op
                                ,Lex: Lex
                                ,Ref: Ref
                                ,grammar: grammar
                                ,rule: rule
...
Elm.Utils.make = function (_elm) {
   ...
   var onlyOne = function (list) {
      onlyOne: while (true) {
         ...
         if (_p1.ctor === "[]") {
               ...
               if (_p1._0.ctor === "Just") {
                     var _p2 = $Maybe.oneOf(_p1._1);
                     if (_p2.ctor === "Just") {
                           return $Maybe.Nothing;
                        } else {
                           return $Maybe.Just(_p1._0._0);
                        }
                  } else {
                     var _v4 = _p1._1;
                     list = _v4;
   ...
   var oneOfScan = F3(function (fn,val,list) {
      oneOfScan: while (true) {
         var _p3 = list;
         if (_p3.ctor === "[]") {
               return $Maybe.Nothing;
            } else {
               var _p4 = A2(fn,_p3._0,val);
               if (_p4.ctor === "Err") {
                     var _v7 = fn,_v8 = _p4._0,_v9 = _p3._1;
                     fn = _v7;
                     val = _v8;
                     list = _v9;
                     continue oneOfScan;
   ...
   var oneOfMap = F2(function (fn,list) {
      oneOfMap: while (true) {
         var _p5 = list;
         if (_p5.ctor === "[]") {
               return $Maybe.Nothing;
   ...
   var allOf = function (maybes) {
      ...
      if (_p7.ctor === "[]") {
            ...
            if (_p7._0.ctor === "Just") {
                  return A2($Maybe.map,
                  function (rest) {
                     return A2($List._op["::"],_p7._0._0,rest);
                  },
                  allOf(_p7._1));
               } else {
                  return $Maybe.Nothing;
   ...
   var tryUpdate = F2(function (f,al) {
      var al$ = A2($List.map,f,al);
      var _p8 = $Maybe.oneOf(al$);
      if (_p8.ctor === "Just") {
            return $Maybe.Just(A3($List.map2,$Maybe.withDefault,al,al$));
         } else {
            return $Maybe.Nothing;
         }
   });
   var tryPrepend = F2(function (a,maybe) {
      return A2($Maybe.map,
      F2(function (x,y) {    return A2($List._op["::"],x,y);})(a),
      maybe);
   });
   var prepend = F2(function (x,y) {
      return A2($List._op["::"],x,y);
   });
   return _elm.Utils.values = {_op: _op
                              ,prepend: prepend
                              ,tryPrepend: tryPrepend
                              ,tryUpdate: tryUpdate
                              ,allOf: allOf
                              ,oneOfMap: oneOfMap
                              ,oneOfScan: oneOfScan
...
Elm.AST = Elm.AST || {};
Elm.AST.make = function (_elm) {
   "use strict";
   _elm.AST = _elm.AST || {};
   if (_elm.AST.values) return _elm.AST.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var match = F3(function (template,terms,f) {
         ...
         if (_p0.ctor === "_Tuple2") {
               if (_p0._0.ctor === "::") {
                     if (_p0._0._0.ctor === "Ref") {
                           if (_p0._1.ctor === "::") {
                                 return A2($Utils.tryPrepend,
                                 _p0._1._0,
                                 A3(match,_p0._0._1,_p0._1._1,f));
                              } else {
                                 break _v0_3;
                              }
                        } else {
   ...
   var translate = F3(function (grammar,_p1,f) {
      var _p2 = _p1;
      return A2($Maybe.andThen,
      A3($Grammar.get,_p2.name,_p2.alt,grammar),
      function (alt) {
         return A3(match,alt,_p2.terms,f);
      });
   });
   var indecies = F2(function (i,list) {
      var _p3 = list;
      if (_p3.ctor === "[]") {
            return _U.list([]);
         } else {
            var index = i + _p3._0.size;
            return A2($List._op["::"],index,A2(indecies,index,_p3._1));
         }
   });
   var getType = function (_p4) {
      var _p5 = _p4;
      return {ctor: "_Tuple2",_0: _p5.name,_1: _p5.alt};
   };
   var map = F2(function (fn,a) {
      return _U.update(a,{terms: A2($List.map,fn,a.terms)});
   });
   var unfix = function (_p6) {    var _p7 = _p6;return _p7._0;};
   var getTerms = function (_p8) {
      var _p9 = _p8;
   ...
   var collectPath = F3(function (id,$default,clt) {
      var step = F2(function (i,terms) {
         var _p12 = terms;
         if (_p12.ctor === "[]") {
               return _U.list([]);
               ...
               var _p14 = _p12._0;
               var _p13 = _p12._1;
               return _U.cmp(i,id) < 0 && _U.cmp(id,
               i + _p14.size) < 1 ? A2($List._op["::"],
               A2(iterate,i,_p14),
               A2(step,_p14.size + i,_p13)) : A2($List._op["::"],
               A2($default,i + _p14.size,_p14),
               A2(step,_p14.size + i,_p13));
            }
      });
      var iterate = F2(function (i,tree) {
         return A2(clt,i + tree.size,A2(mapS,step(i),tree));
   ...
   var subIndecies = F2(function (id,tree) {
      return A2(indecies,id - tree.size,getTerms(tree));
   });
   var subWithIndecies = F2(function (id,tree) {
      return A3($List.map2,
      F2(function (v0,v1) {
         return {ctor: "_Tuple2",_0: v0,_1: v1};
      }),
      A2(subIndecies,id,tree),
      getTerms(tree));
   });
   var first = function (itr) {
      var step = F2(function (term,i) {
         var _p15 = A2(iterate,i,term);
         if (_p15.ctor === "Nothing") {
               return $Result.Err(i + term.size);
            } else {
               return $Result.Ok(_p15._0);
            }
      });
      var iterate = F2(function (i,tree) {
         var _p16 = A3($Utils.oneOfScan,step,i,getTerms(tree));
   ...
   var search = F2(function (id,itr) {
      var step = F2(function (term,i) {
         if (_U.cmp(i,id) < 0 && _U.cmp(id,i + term.size) < 1) {
               var _p17 = A2(iterate,i,term);
               if (_p17.ctor === "Nothing") {
                     return $Result.Err(i + term.size);
                  } else {
                     return $Result.Ok(_p17._0);
                  }
            } else return $Result.Err(i + term.size);
      });
      var iterate = F2(function (i,tree) {
         var _p18 = A3($Utils.oneOfScan,step,i,getTerms(tree));
   ...
   var SubTree = function (a) {
      return {ctor: "SubTree",_0: a};
   };
   var syntax = F3(function (name,alt,terms) {
      return {name: name
             ,alt: alt
             ,terms: A2($List.map,SubTree,terms)
             ,size: $List.sum(A2($List.map,
             function (_) {
                return _.size;
             },
             terms)) + 1};
   ...
   return _elm.AST.values = {_op: _op
                            ,SNode: SNode
                            ,SubTree: SubTree
                            ,unfix: unfix
                            ,map: map
...
Elm.Arithmetic.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var lang = $Grammar.grammar(_U.list([{ctor: "_Tuple2"
                                        ,_0: "Exp"
                                        ,_1: $Grammar.rule(_U.list([_U.list([$Grammar.Ref("AddExp")])]))}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "AddExp"
                                        ,_1: $Grammar.rule(_U.list([_U.list([$Grammar.Ref("AddExp")
                                                                            ,$Grammar.Lex("+")
                                                                            ,$Grammar.Ref("MulExp")])
                                                                   ,_U.list([$Grammar.Ref("AddExp")
                                                                            ,$Grammar.Lex("-")
                                                                            ,$Grammar.Ref("MulExp")])
                                                                   ,_U.list([$Grammar.Ref("MulExp")])]))}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "MulExp"
                                        ,_1: $Grammar.rule(_U.list([_U.list([$Grammar.Ref("MulExp")
                                                                            ,$Grammar.Lex("*")
                                                                            ,$Grammar.Ref("ExpExp")])
                                                                   ,_U.list([$Grammar.Ref("MulExp")
                                                                            ,$Grammar.Lex("/")
                                                                            ,$Grammar.Ref("ExpExp")])
                                                                   ,_U.list([$Grammar.Ref("ExpExp")])]))}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "ExpExp"
                                        ,_1: $Grammar.rule(_U.list([_U.list([$Grammar.Ref("PriExp")
                                                                            ,$Grammar.Lex("^")
                                                                            ,$Grammar.Ref("ExpExp")])
                                                                   ,_U.list([$Grammar.Ref("PriExp")])]))}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "PriExp"
                                        ,_1: $Grammar.rule(_U.list([_U.list([$Grammar.Lex("(")
                                                                            ,$Grammar.Ref("Exp")
                                                                            ,$Grammar.Lex(")")])
                                                                   ,_U.list([$Grammar.Lex("-"),$Grammar.Ref("PriExp")])
                                                                   ,_U.list([$Grammar.Ref("ident")])
                                                                   ,_U.list([$Grammar.Ref("number")])]))}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "ident"
                                        ,_1: $Grammar.rule(_U.list([_U.list([$Grammar.Ref("alpha")
                                                                            ,$Grammar.Ref("ident")])
                                                                   ,_U.list([$Grammar.Ref("alpha")])]))}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "alpha"
                                        ,_1: $Grammar.oneOf("abcdefghijklmnopqrstuvxyz")}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "number"
                                        ,_1: $Grammar.rule(_U.list([_U.list([$Grammar.Ref("digit")
                                                                            ,$Grammar.Ref("number")])
                                                                   ,_U.list([$Grammar.Ref("digit")])]))}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "digit"
                                        ,_1: $Grammar.oneOf("0123456789")}]));
   return _elm.Arithmetic.values = {_op: _op,lang: lang};
};
Elm.Command = Elm.Command || {};
Elm.Command.make = function (_elm) {
   "use strict";
   _elm.Command = _elm.Command || {};
   if (_elm.Command.values) return _elm.Command.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   var smartIn = F2(function (tree,id) {
      var goInWithType = F3(function (t,i,tree) {
         ...
         if (_p0.ctor === "Just") {
               var _p2 = _p0._0;
               if (_U.eq($AST.getType(_p2),t)) {
                     var _p1 = A3(goInWithType,t,i,_p2);
                     if (_p1.ctor === "Nothing") {
                           return $Maybe.Just(i + _p2.size);
                        } else {
                           return _p1;
                        }
                  } else return $Maybe.Just(i + _p2.size);
            } else {
               return $Maybe.Nothing;
            }
      });
      var downIterator = F2(function (i,tree) {
         return _U.eq(i,id) ? A3(goInWithType,
         $AST.getType(tree),
         id - tree.size,
         tree) : $Maybe.Nothing;
      });
   ...
   var smartOut = F2(function (tree,id) {
      var upIterator = F2(function (i,tree) {
         ...
         if (_U.eq(i,id)) return $Maybe.Just({ctor: "_Tuple2"
                                             ,_0: i
                                             ,_1: $Maybe.Just(t)}); else {
               var _p3 = $Maybe.oneOf(tree.terms);
               if (_p3.ctor === "Just" && _p3._0.ctor === "_Tuple2" && _p3._0._1.ctor === "Just")
               {
                     var _p4 = _p3._0._0;
                     return _U.eq(_p3._0._1._0,t) || _U.eq(_p4,
                     id) ? $Maybe.Just({ctor: "_Tuple2"
                                       ,_0: i
                                       ,_1: $Maybe.Just(t)}) : $Maybe.Just({ctor: "_Tuple2"
                                                                           ,_0: _p4
                                                                           ,_1: $Maybe.Nothing});
                  } else {
                     return _p3;
   ...
   var ChildStuck = {ctor: "ChildStuck"};
   ...
   var smartNext = F2(function (tree,id) {
      var findNext = F2(function (pt,indecies) {
         findNext: while (true) {
            ...
            if (_p6.ctor === "::") {
                  if (_p6._1.ctor === "::") {
                        var _p9 = _p6._1._0._0._0;
                        var _p7 = _p6._0._1;
                        if (_p7.ctor === "Err") {
                              switch (_p7._0.ctor)
                              {case "Stuck": var _p8 = _p6._1._0._0._2;
                                   if (_p8.ctor === "Just") {
                                         return _U.eq(pt,
                                         _p6._1._0._0._1) ? $Result.Ok(_p8._0) : $Result.Ok(_p9);
                                      } else {
                                         return $Result.Ok(_p9);
                                      }
                                 case "ChildStuck": return _U.eq(_p6._0._0._1,
                                   pt) ? $Result.Ok(_p9) : $Result.Err(GiveUp);
                                 default: var _v6 = pt,
                                   _v7 = A2($List._op["::"],_p6._1._0,_p6._1._1);
                                   pt = _v6;
                                   indecies = _v7;
                                   continue findNext;}
                           } else {
                              return $Result.Ok(_p7._0);
                           }
                     } else {
                        var _p10 = _p6._0._1;
                        _v8_2: do {
                           if (_p10.ctor === "Err") {
                                 switch (_p10._0.ctor)
                                 {case "Stuck": return $Result.Err(ChildStuck);
                                    case "ChildStuck": return $Result.Err(GiveUp);
                                    default: break _v8_2;}
                              } else {
                                 break _v8_2;
                              }
                  ...
                  return $Result.Err(GiveUp);
               }
         }
      });
      var helper = function (_p11) {
         var _p12 = _p11;
         return _p12._0._0;
      };
      var nextIterator = F2(function (i,tree) {
         return {ctor: "_Tuple2"
                ,_0: A3(SNInfo,
                i,
                $AST.getType(tree),
                A2($Maybe.map,helper,$List.head(tree.terms)))
                ,_1: _U.eq(i,id) ? $Result.Err(Stuck) : A2(findNext,
                $AST.getType(tree),
                tree.terms)};
      });
   ...
   var smartPrev = F2(function (tree,id) {
      var findPrev = F2(function (pt,indecies) {
         findPrev: while (true) {
            ...
            if (_p14.ctor === "::") {
                  if (_p14._1.ctor === "::") {
                        var _p18 = _p14._0._0._0;
                        var _p15 = _p14._1._0._1;
                        if (_p15.ctor === "Err") {
                              switch (_p15._0.ctor)
                              {case "Stuck": var _p16 = _p14._0._0._2;
                                   if (_p16.ctor === "Just") {
                                         return _U.eq(pt,
                                         _p14._0._0._1) ? $Result.Ok(_p16._0) : $Result.Ok(_p18);
                                      } else {
                                         return $Result.Ok(_p18);
                                      }
                                 case "ChildStuck": return _U.eq(_p14._1._0._0._1,
                                   pt) ? $Result.Ok(_p18) : $Result.Err(GiveUp);
                                 default: var _p17 = _p14._0._1;
                                   if (_p17.ctor === "Ok") {
                                         return $Result.Ok(_p17._0);
                                      } else {
                                         if (_p17._0.ctor === "Stuck") {
                                               return $Result.Err(ChildStuck);
                                            } else {
                                               var _v14 = pt,
                                               _v15 = A2($List._op["::"],_p14._1._0,_p14._1._1);
                                               pt = _v14;
                                               indecies = _v15;
                                               continue findPrev;
                                            }
      ...
      var helper = function (_p20) {
         var _p21 = _p20;
         return _p21._0._0;
      };
      var prevIterator = F2(function (i,tree) {
         return {ctor: "_Tuple2"
                ,_0: A3(SNInfo,
                i,
                $AST.getType(tree),
                A2($Maybe.map,helper,$Utils.last(tree.terms)))
                ,_1: _U.eq(i,id) ? $Result.Err(Stuck) : A2(findPrev,
                $AST.getType(tree),
                tree.terms)};
      });
   ...
   var prev = F2(function (tree,id) {
      var prev$ = function (indecies) {
         prev$: while (true) {
            ...
            if (_p23.ctor === "::" && _p23._1.ctor === "::") {
                  var _p24 = _p23._1._0;
                  if (_U.eq(id,_p24)) return $Maybe.Just(_p23._0); else {
                        var _v19 = A2($List._op["::"],_p24,_p23._1._1);
                        indecies = _v19;
                        continue prev$;
                     }
               } else {
      ...
      var prevIterator = F2(function (i,tree) {
         return prev$(A2($AST.subIndecies,i,tree));
      });
      return A2($Maybe.withDefault,
      id,
      A3($AST.search,id,prevIterator,tree));
   });
   var next = F2(function (tree,id) {
      var next$ = function (indecies) {
         next$: while (true) {
            var _p25 = indecies;
            if (_p25.ctor === "::" && _p25._1.ctor === "::") {
                  var _p26 = _p25._1._0;
                  if (_U.eq(id,_p25._0)) return $Maybe.Just(_p26); else {
                        var _v21 = A2($List._op["::"],_p26,_p25._1._1);
                        indecies = _v21;
                        continue next$;
                     }
               } else {
      ...
      var nextIterator = F2(function (i,tree) {
         return next$(A2($AST.subIndecies,i,tree));
      });
      return A2($Maybe.withDefault,
      id,
      A3($AST.search,id,nextIterator,tree));
   });
   var parrent = F2(function (tree,id) {
      var parrentIterator = F2(function (i,tree) {
         return A2($List.member,
         id,
         A2($AST.subIndecies,i,tree)) ? $Maybe.Just(i) : $Maybe.Nothing;
      });
      return A2($Maybe.withDefault,
      id,
      A3($AST.search,id,parrentIterator,tree));
   });
   var child = F2(function (tree,id) {
      var childIterator = F2(function (i,tree) {
         return _U.eq(i,id) ? $List.head(A2($AST.subIndecies,
         i,
         tree)) : $Maybe.Nothing;
      });
      return A2($Maybe.withDefault,
   ...
   var update = F2(function (id,fn) {
      ...
      var update$ = F2(function (i,node) {
         if (_U.eq(id,i)) {
               ...
               return {ctor: "_Tuple2",_0: i - node.size + rval.size,_1: rval};
            } else {
               var idx = A2($Maybe.withDefault,
               0,
               $List.maximum(A2($List.map,$Basics.fst,node.terms)));
               return {ctor: "_Tuple2",_0: idx,_1: toTree(node)};
            }
      });
      return A3($AST.collectPath,
      id,
      F2(function (i,tree) {
         return {ctor: "_Tuple2",_0: 0,_1: tree};
      }),
      update$);
   });
   var get = function (id) {
      var get$ = F2(function (i,tree) {
         return _U.eq(i,id) ? $Maybe.Just(tree) : $Maybe.Nothing;
      });
      return A2($AST.search,id,get$);
   };
   ...
   var dpprint = function (_p2) {
      ...
      var collector = F2(function (id,tree) {
         ...
         _U.eq(_p4,id) ? _U.list([{ctor: "_Tuple2"
                                 ...
                                 ,{ctor: "_Tuple2"
                                  ,_0: "color"
                                  ,_1: "lightblue"}]) : _U.list([{ctor: "_Tuple2"
                                                                 ,_0: "background"
                                                                 ,_1: "lightblue"}])))]),
